      ...
      <div className="relative container-custom pt-16 pb-24 md:pt-24 md:pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-white fade-in">
            ...
            <p className="text-xl mb-8 text-gray-100 max-w-xl">
              Our cutting-edge AI technology, developed by NIET students, detects deepfakes with 99.7% accuracy, protecting you from synthetic media threats.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Link to="/detect" className="btn bg-white text-primary-800 hover:bg-gray-100">
                <span>Try Now</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {['Industry-leading accuracy', 'Developed by NIET students', 'Secure & private analysis'].map((feature, index) => (
                <div key={index} className="flex items-center">
                  <CheckCircle size={20} className="mr-2 text-accent-400" />
                  <span className="text-sm">{feature}</span>
                </div>
